	...
	<body id="invoicePrint">
		...
		<div class="invoice-box">
			...
			<div class="footer-section" style="text-align: center;">
				<!-- <a href="#" class="btn btn-primary" onclick="myApp.printTable()">Print</a> -->
				<a href="{{route('admin.send.email.invoice.customer',$order->order_id)}}" class="btn btn-primary">Send Invoice To Customer</a>
		...
		<script>
		 //   var myApp = new function () {
		   ...
		   //          var tab = document.getElementById('invoicePrint');
					// var htmlToPrint = '' +
					// '<style type="text/css">' +
					// 'table th, table td {' +
