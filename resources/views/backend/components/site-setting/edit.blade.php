...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>Update Site Settings</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Update Site Settings from the following form.</h5>
                </div>
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" action="{{route('admin.site-setting.update',$setting->id)}}" enctype="multipart/form-data">
                        @csrf()
